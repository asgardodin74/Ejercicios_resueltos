let letraNombre = {
    ...
    h: {
    masculino: 'letal',femenino: 'letal'
    },
    i: {
    masculino: 'poderoso',
    femenino: 'poderosa'
    ...
    let apellido=prompt("Escribe el apellido: ");
    let fecha=prompt("Escriba la fecha de nacimiento: ");
    let n=nombre.substring(0,1);
    let a=apellido.substring(apellido.length-1);
    let f=fecha.substring(fecha.length-1);
    console.log(letraNombre[n].masculino+" "+letraApellido[a].masculino+" "+fechaNacimiento[f].masculino);
